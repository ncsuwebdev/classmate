...
<p style="float: left;"><input id="previousWeekButton" type="button" value="&lsaquo; Previous Week"></p>
<p style="float: right;"><input id="nextWeekButton" type="button" value="Next Week &rsaquo;"></p>
        ...
        <tr>
            ...
            {foreach from=$calendar item=d}
                ...
                {foreach name=events from=$d.events item=e}
                    ...
                    <div class="event {$day.dayId}_{$r.roomId}" id="{$e.eventId}" style="height: {$e.numMinutes}px;">
