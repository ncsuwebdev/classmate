...
class Internal_Acl extends Zend_Acl
{
    ...
    public function __construct()
    {
        ...
        $this->add(new Zend_Acl_Resource('room_index'));
        $this->add(new Zend_Acl_Resource('room_import'));
        $this->add(new Zend_Acl_Resource('room_building'));
        $this->add(new Zend_Acl_Resource('room_schedule'));
        $this->add(new Zend_Acl_Resource('room_type'));
        $this->add(new Zend_Acl_Resource('task_index'));
        $this->add(new Zend_Acl_Resource('task_component'));
        $this->add(new Zend_Acl_Resource('task_scheduler'));
        $this->add(new Zend_Acl_Resource('asset_index'));
        $this->add(new Zend_Acl_Resource('asset_manufacturer'));
        $this->add(new Zend_Acl_Resource('portal_index'));
